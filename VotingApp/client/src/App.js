...
class App extends Component {
  ...
  runInit = async() => {
    ...
    this.setState({whitelist, workflow: parseInt(workflow), winningProposalId, isOwner, proposals });
            ...
            case 0:
              return (
                <div>
                  ...
                  <br></br>
                  {this.state.isOwner && <Button onClick={this.handleSubmitStartProposalsRegistration}>Start Proposals Registration</Button>}
                </div>
              )
            case 1:
              return (
                <div>
                  ...
                  <br></br>
                  {this.state.isOwner && <Button onClick={this.handleSubmitEndProposalsRegistration}>End Proposals Registration</Button>}
                </div>
              )
            case 2:
              return (
                <div>
                  ...
                  {this.state.isOwner && <Button onClick={this.handleSubmitStartVotingSession}>Start Voting Session</Button>}
                </div>
              )
            case 3:
              return (
                <div>
                  ...
                  <br></br>
                  {this.state.isOwner && <Button onClick={this.handleSubmitEndVotingSession}>End Voting Session</Button>}
                </div>
              )
            case 4:
              return (
                <div>
                  <h2>Tally Votes</h2>
                  <br></br>
                  {this.state.isOwner && <Button onClick={this.handleSubmitTallyVotes}>See results</Button>}
                </div>
              )
            case 5:
              return (
